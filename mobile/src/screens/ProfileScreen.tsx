...
const styles = StyleSheet.create({
  ...
  loginButton: { backgroundColor: '#FF6B35', paddingVertical: 14, paddingHorizontal: 40, borderRadius: 12, marginTop: 24 },
  loginButtonText: { fontSize: 16, fontWeight: 'bold', color: '#FFF' },
  header: { alignItems: 'center', paddingVertical: 30 },
  avatarContainer: { marginBottom: 16 },
  avatar: { width: 100, height: 100, borderRadius: 50 },
  avatarPlaceholder: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#FF6B35', justifyContent: 'center', alignItems: 'center' },
  ...
  editButtonText: { color: '#FF6B35', fontWeight: '600' },
